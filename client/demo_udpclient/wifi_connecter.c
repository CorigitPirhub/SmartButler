...
char CLIENT_HOST[128] = "0.0.0.0";
char RGB_HOST[128] = "192.168.43.82";
char DIM_HOST[128] = "192.168.43.128";
char DOOR_HOST[128] = "192.168.43.221";
...
int ConnectToHotspot(WifiDeviceConfig* apConfig)
{
    ...
    if (g_iface) {
        ...
        if (ret == ERR_OK) {
            strcpy(CLIENT_HOST, ip4addr_ntoa(&ip));
            printf("ip = %s\r\n", ip4addr_ntoa(&ip));
